========================================================================
    APLICACIÓN: AgregarUnFormulario Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación AgregarUnFormulario.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación AgregarUnFormulario.

AgregarUnFormulario.vcxproj
...
AgregarUnFormulario.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado AgregarUnFormulario.pch y un archivo de tipos precompilados llamado StdAfx.obj.
